export function clearSimpleFormFieldsErrorsOnFocus() {
  clearSimpleFormFieldErrorsOnFocus();
  clearSimpleFormRichTextFieldErrorsOnFocus();
}

function clearSimpleFormFieldErrorsOnFocus() {
  document.querySelectorAll('input[aria-invalid=true]')
    .forEach(input => input.addEventListener('focus', clearInputErrors));
...
function clearSimpleFormRichTextFieldErrorsOnFocus() {
  document.querySelectorAll('.ck-editor__editable')
    .forEach(editor => editor.addEventListener('focus', clearRichTextFieldErrors));
